...
function listings (req, res) {
  ...
  var url = 'https://api.booli.se/listings?objectType=fritidshus&center=59.36951,17.97762&dim=300000&maxSoldPrice=600000&limit=50&offset=0&callerId='+nconf.get('callerId')+'&time='+unix+'&unique='+unique+'&hash='+hash
  var options = {
    headers: {
